    ...
    <div className={styles["billboard-info-container"]}>
      ...
      <div className={styles["billboard-button-container"]}>
        ...
        >
          ...
          <span className={styles["billboard-button-text"]}>Play</span>
        </Button>
        <Button
          className={`${styles["billboard-button"]} ${styles["billboard-info-button"]}`}
        >
          {infoIcon}
          <div style={{ width: "1rem" }}></div>
          <span className={styles["billboard-button-text"]}>More Info</span>
        </Button>
      </div>
    </div>
  );
